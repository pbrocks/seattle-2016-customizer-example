...
if ( defined( 'PANTHEON_ENVIRONMENT' ) && ( PANTHEON_ENVIRONMENT !== 'live' ) ) {
	...
	*/
	...
	my_wp_cfm_runcmd( 'wp plugin activate wp-cfm 2>&1', 'Making sure that wp-cfm plugin is activated' );

	my_wp_cfm_runcmd( "wp config pull $config_name 2>&1", "pulling config for $config_name" );
}
